 ...
 * @author Timmer
 */
public class EventTreePanelv6 extends JPanel implements TreeSelectionListener {
    ...
    void setTableData(String[] data) {
        MyTableModel2 model = (MyTableModel2)dataTable.getModel();
	...
	protected void addComponents() {
        ...
        dataTable = new JTable(new MyTableModel2());
        MyRenderer2 renderer = new MyRenderer2(5);
